...
#ifdef __APPLE__
/* proton-mac: larger kernel stack — headroom for the deeper ARM64EC dispatch +
 * Mach exception call chains on macOS. Harmless upside (not a specific bug fix). */
static const SIZE_T kernel_stack_size = 0x800000;
#else
